...
const DEFAULT_GROCERY_STORES = [
  ...
  },
  {
    ...
    menu: [
      ...
      { id: 30502, name: 'Verka Full Cream Milk (500 ml)', desc: 'Rich and creamy milk, hygienically packed.', price: 38, img: 'https://images.unsplash.com/photo-1601436423474-51738541c9c5?w=400&q=80&auto=format', veg: true, bestseller: true, stock: 140, reorderLevel: 24, category: 'dairy', unit: 'pack', sku: 'VRK-FCM-500' },
      { id: 30503, name: 'Verka Curd (400 g)', desc: 'Fresh probiotic curd with a smooth texture.', price: 46, img: 'https://images.unsplash.com/photo-1571212515416-fef01fc43637?w=400&q=80&auto=format', veg: true, bestseller: true, stock: 100, reorderLevel: 16, category: 'dairy', unit: 'cup', sku: 'VRK-CRD-400' },
      { id: 30504, name: 'Verka Paneer (200 g)', desc: 'Soft paneer block for curries and snacks.', price: 92, img: 'https://images.unsplash.com/photo-1631452180519-c014fe946bc7?w=400&q=80&auto=format', veg: true, bestseller: true, stock: 90, reorderLevel: 14, category: 'dairy', unit: 'pack', sku: 'VRK-PNR-200' },
      { id: 30505, name: 'Verka Plain Lassi (180 ml)', desc: 'Classic chilled lassi for everyday refreshment.', price: 24, img: 'https://images.unsplash.com/photo-1626201850129-a96f7f07c151?w=400&q=80&auto=format', veg: true, bestseller: false, stock: 160, reorderLevel: 30, category: 'dairy', unit: 'bottle', sku: 'VRK-LSI-180' },
      { id: 30506, name: 'Verka Sweet Lassi (200 ml)', desc: 'Sweet Punjabi lassi with a creamy taste.', price: 28, img: 'https://images.unsplash.com/photo-1626201850129-a96f7f07c151?w=400&q=80&auto=format', veg: true, bestseller: false, stock: 150, reorderLevel: 24, category: 'dairy', unit: 'bottle', sku: 'VRK-SLS-200' },
      { id: 30507, name: 'Verka Butter (100 g)', desc: 'Salted table butter made from fresh cream.', price: 58, img: 'https://images.unsplash.com/photo-1589985270958-b3f00b3e1f87?w=400&q=80&auto=format', veg: true, bestseller: false, stock: 95, reorderLevel: 14, category: 'dairy', unit: 'pack', sku: 'VRK-BTR-100' },
      { id: 30508, name: 'Verka Ghee (500 ml)', desc: 'Traditional ghee with rich aroma and purity.', price: 349, img: 'https://images.unsplash.com/photo-1626201850129-a96f7f07c151?w=400&q=80&auto=format', veg: true, bestseller: false, stock: 70, reorderLevel: 10, category: 'dairy', unit: 'jar', sku: 'VRK-GHE-500' },
    ],
  },
];
